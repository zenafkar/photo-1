        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
          ...
          <div className="sm:col-span-2 lg:col-span-1">
            <div className="flex items-center gap-2.5 mb-4">
              ...
              <span className="font-display text-lg font-extrabold text-text tracking-tight">ZenStudio</span>
            </div>
            ...
            <div className="flex gap-3">
              <a href="#" className="w-10 h-10 rounded-full bg-surface flex items-center justify-center text-text-muted hover:text-primary hover:bg-surface-border border border-surface-border transition-all" aria-label="Instagram">
                <InstagramIcon className="w-5 h-5" />
              </a>
              <a href="#" className="w-10 h-10 rounded-full bg-surface flex items-center justify-center text-text-muted hover:text-primary hover:bg-surface-border border border-surface-border transition-all" aria-label="TikTok">
              ...
              <a href="#" className="w-10 h-10 rounded-full bg-surface flex items-center justify-center text-text-muted hover:text-primary hover:bg-surface-border border border-surface-border transition-all" aria-label="WhatsApp">
