        ...
        <div className="p-5 sm:p-6 flex flex-col gap-5">
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            >
              ...
              <span className="text-xs text-slate-400 mt-1 block">~{PACKAGES.starter.credits}x Generate</span>
            </button>
            ...
            >
              ...
              <span className="text-xs text-slate-400 mt-1 block">~{PACKAGES.pro.credits}x Generate</span>
            </button>
          </div>
          ...
          <p className="text-[11px] text-slate-400 text-center">
            Anda akan diarahkan ke halaman pembayaran Xendit yang aman. Pembayaran diproses oleh Xendit (disupervisi oleh Bank Indonesia).
          </p>
        </div>
      </div>
    </div>
