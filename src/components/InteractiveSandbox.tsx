...
const InteractiveSandbox = () => {
  const styles = [
    { 
      ...
      subtitle: 'Silk & Warm Lighting',
      prompt: 'Parfum Mystiq, foto di atas keyboard laptop — diubah jadi elegan dengan background batu alam, kain sutra, dan pencahayaan studio dramatis.',
        ...
        <div className="grid lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          <div className="lg:col-span-5 flex flex-col justify-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 items-center">
              ...
              <span className="text-xs text-slate-400 font-mono">⚡ Gratis 3 foto/bulan</span>
            </div>
          </div>
